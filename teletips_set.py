...
TELETIPS_MAIN_MENU_BUTTONS = [
            ...
            [
                ...
                InlineKeyboardButton('📣 CHANNEL', url='https://t.me/ehivpsssh'),
                InlineKeyboardButton('👨‍💻 CREATOR', url='https://t.me/networkchukka')
            ],
            [
...
async def callback_query(client: Client, query: CallbackQuery):
    if query.data=="HELP_CALLBACK":
        ...
        TELETIPS_GROUP_BUTTONS = [
            [
                InlineKeyboardButton("Ehivpnssh Channel", url="https://t.me/ehivpsssh")
            ],
            [
                InlineKeyboardButton("Ehivpnssh Group", url="https://t.me/ehivpnssh")
            ],
            [
                InlineKeyboardButton("⬅️ BACK", callback_data="START_CALLBACK"),
            ]
        ...
        TELETIPS_TUTORIAL_BUTTONS = [
            [
                InlineKeyboardButton("🎥 Video", url="https://t.me/ehivpsssh/462")
            ],
            [
                InlineKeyboardButton("⬅️ BACK", callback_data="START_CALLBACK"),
            ]
